...
public class telaCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Suranna", 1, 18)); // NOI18N
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        // ELEVADO AO CUBO
        //Math.pow recebe e retorna valor(es) Double
        double cubo = Math.pow(num, 3); 
        lblCubo.setText(Double.toString(cubo));
        
        //RAIZ QUADRADA
        Double raiz = Math.sqrt(num);
        lblRaizQ.setText(String.format("%.4f",raiz));
        ...
        // VISIBILIDADE DO PAINEL APÓS O CLICK
