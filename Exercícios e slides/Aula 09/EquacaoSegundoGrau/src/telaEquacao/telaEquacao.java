...
public class telaEquacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblA.setFont(new java.awt.Font("Liberation Sans", 1, 24)); // NOI18N
        lblA.setForeground(new java.awt.Color(204, 0, 0));
        lblA.setText("A");

        lblB.setFont(new java.awt.Font("Liberation Sans", 1, 24)); // NOI18N
        lblB.setForeground(new java.awt.Color(204, 0, 0));
        lblB.setText("B");

        lblC.setFont(new java.awt.Font("Liberation Sans", 1, 24)); // NOI18N
        ...
        lblDelta.setFont(new java.awt.Font("Liberation Sans", 1, 18)); // NOI18N
        lblDelta.setForeground(new java.awt.Color(0, 0, 153));
        lblDelta.setText("0");

        lblRaiz.setFont(new java.awt.Font("Liberation Sans", 1, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (d < 0) {
            lblRaiz.setText("Não tem raiz real.");
        } else{
